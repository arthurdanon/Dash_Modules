// src/PageAuth/ResetPassword.jsx
  ...
  if (!token) {
    return (
      <div className="max-w-md mx-auto p-6">
        ...
        <p className="mt-2 text-zinc-600">Le lien de réinitialisation est manquant ou invalide.</p>
  ...
  if (ok) {
    return (
      <div className="max-w-md mx-auto p-6">
        ...
        <p className="mt-2 text-zinc-600">Vous pouvez maintenant vous connecter.</p>
  ...
  return (
    <div className="max-w-md mx-auto p-6">
      ...
      <form onSubmit={submit} className="grid gap-3 mt-4">
        ...
        <input className="input" type="password" value={pwd} onChange={(e) => setPwd(e.target.value)} placeholder="********" autoFocus />
